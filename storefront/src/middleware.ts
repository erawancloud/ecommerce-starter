...
// Thailand, because that is who this shop sells to. Upstream defaults to "us",
// which on a shop whose only region is ไทย means every first visit falls
// through to `regionMap.keys().next()` — right by accident, and wrong the day
